    ...
    public partial class initial42346456e : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachersToClassRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeachersToClassRooms_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachersToClassRooms_ApplicationUserId",
                table: "TeachersToClassRooms",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachersToClassRooms_ClassRoomId",
                table: "TeachersToClassRooms",
                column: "ClassRoomId");
        }
