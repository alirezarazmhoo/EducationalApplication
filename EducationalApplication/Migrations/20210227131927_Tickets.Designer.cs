...
namespace EducationalApplication.Migrations
{
    ...
    [Migration("20210227131927_Tickets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationalApplication.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2a76fcc7-757f-49a6-9dfe-ee34c0a5e4f0",
                            CreateDate = new DateTime(2021, 2, 27, 16, 49, 26, 894, DateTimeKind.Local).AddTicks(6958),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGzayFCtht8eyFMvw4gyGAsOZyT0Ox3YjF840Mv1lPLdgUiEYkJ0Opd83Y77A3tARg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1f852b47-7210-426b-ae94-28a46a9f7abd",
            ...
            modelBuilder.Entity("EducationalApplication.Models.AboutUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EducationalApplication.Models.Announcements", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsOnlyForTeacher")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EducationalApplication.Models.CommentMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EducationalApplication.Models.CustomGroupsToEducationPosts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CustomGroupsToEducationPosts");
                });
            ...
            modelBuilder.Entity("EducationalApplication.Models.Favorit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EducationalApplication.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("StudentReceiver")
                        .HasColumnType("int");

                    b.Property<string>("TeacherReceiver")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EducationalApplication.Models.TicketMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EducationalApplication.Models.CommentMedia", b =>
                {
                    b.HasOne("EducationalApplication.Models.Comment", "Comment")
            ...
            modelBuilder.Entity("EducationalApplication.Models.CustomGroupsToEducationPosts", b =>
                {
                    ...
                    b.HasOne("EducationalApplication.Models.EducationPost", "EducationPost")
                        .WithMany("CustomGroupsToEducationPosts")
                        .HasForeignKey("EducationPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EducationalApplication.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("EducationalApplication.Models.Students", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("EducationalApplication.Models.TicketMedia", b =>
                {
                    b.HasOne("EducationalApplication.Models.Ticket", "Tiket")
                        .WithMany("Medias")
            ...
            modelBuilder.Entity("EducationalApplication.Models.UsersToEducationPost", b =>
                {
                    ...
                    b.HasOne("EducationalApplication.Models.EducationPost", "EducationPost")
                        .WithMany("UsersToEducationPosts")
                        .HasForeignKey("EducationPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
